...
def test_update_budget_success(mock_db_session, mock_budget, mock_category):
    """
...
def test_update_budget_partial_amount_only(mock_db_session, mock_budget, mock_category):
    """
