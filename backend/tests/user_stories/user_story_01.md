...
1. La transaction doit contenir obligatoirement : montant, libellé, type (revenu/dépense), catégorie et date
2. Le montant doit être un nombre positif
3. Le type doit être soit `revenu` soit `dépense`
...
```
  ...
  | 45.50   | Courses Carrefour | dépense  | alimentation  | 2026-01-06 |
```
